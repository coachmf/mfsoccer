...
const I18N = {
  ...
  DICT: {
    ...
    'أحد':'Sun', 'إثنين':'Mon', 'ثلاثاء':'Tue', 'أربعاء':'Wed', 'خميس':'Thu', 'جمعة':'Fri', 'سبت':'Sat', 'الأحد':'Sun', 'الإثنين':'Mon', 'الثلاثاء':'Tue', 'الأربعاء':'Wed', 'الخميس':'Thu', 'الجمعة':'Fri', 'السبت':'Sat', 'التفاصيل':'Details',
    ...
    // المسابقات والأندية
    'الدوري':'League', 'كأس الأمير':'Emir Cup', 'كأس السوبر':'Super Cup', 'كأس سمو ولي العهد':'Crown Prince Cup', 'كل المسابقات':'All competitions', 'المباريات القادمة':'Upcoming matches', 'إجمالي البطولات المحلية':'All domestic competitions', 'مساهمات':'Contributions', 'قلب الدفاع':'Centre-back', 'الظهير':'Full-back', 'الحارس':'Goalkeeper', 'أكثر قلوب الدفاع شباكاً نظيفة':'Centre-back with most clean sheets', 'الأظهرة: شباك نظيفة ومساهمة':'Full-backs: clean sheets & contributions', 'أكثر الحرّاس شباكاً نظيفة':'Goalkeeper with most clean sheets', 'لا توجد شباك نظيفة مسجّلة في ⟨x⟩ بعد.':'No clean sheets recorded in ⟨x⟩ yet.', 'لا توجد مباريات مُقامة في ⟨x⟩ بعد.':'No matches played in ⟨x⟩ yet.', 'لم تُرصد مشاركة لهذا اللاعب في ⟨x⟩ بعد.':'No appearances recorded for this player in ⟨x⟩ yet.', 'لا توجد مباريات قادمة.':'No upcoming matches.',
    ...
    'حرّاس المرمى الذين لعبوا ثلثَي المباراة فأكثر — 60 دقيقة في مباراة 90، وأكثر إن طال الوقت بدل الضائع — في مباريات لم يستقبل فيها فريقهم هدفاً.':'Goalkeepers who played two thirds of the match or more — 60 minutes in a 90-minute match, more when stoppage time is long — in matches where their team did not concede.',
    ...
    'ادريس شعيبي':'Idris Shuaibi', 'بدر الدين سوياد':'Badreddine Souyad', 'ناصر الرواحي':'Nasser Al-Rawahi', 'لويسنهو':'Luisinho', 'ايمن لقجع':'Aymen Lakjaa', 'غازي العتيبي':'Ghazi Al-Otaibi', 'عبدالله يوسف':'Abdullah Yousef', 'ناصر خضر':'Nasser Khudhur', 'علي حسن':'Ali Hassan',
  ...
  RX: [
    ...
    [/^(?:ال)?(أحد|إثنين|ثلاثاء|أربعاء|خميس|جمعة|سبت) (\d+) (يناير|فبراير|مارس|أبريل|مايو|يونيو|يوليو|أغسطس|سبتمبر|أكتوبر|نوفمبر|ديسمبر)(?: · (\d+):(\d+) (ص|م))?$/,
