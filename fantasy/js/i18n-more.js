...
const NAMES_EN = {
  ...
  // التضامن
  'داود الخالدي':'Dawoud Al-Khalidi', 'نايف العازمي':'Naif Al-Azmi', 'عمر العازمي':'Omar Al-Azmi', 'ابراهيم الظفيري':'Ibrahim Al-Dhafiri', 'احمد الرشيدي':'Ahmad Al-Rashidi', 'محمد عجاج':'Mohammad Ajaj', 'مزيد نواف':'Mazyad Nawaf', 'حسين العريان':'Hussain Al-Arayan', 'عايد ماجد':'Ayed Majed', 'فواز الداوود':'Fawaz Al-Dawood', 'سعود العنبري':'Saud Al-Anbari', 'حسين اشكناني':'Hussain Ashkanani', 'طلال المطرود':'Talal Al-Matroud', 'عبدالرحمن الاصيمع':'Abdulrahman Al-Usaimi', 'عبدالعزيز المسافر':'Abdulaziz Al-Musafer', 'فهد العميري':'Fahad Al-Umairi', 'علي دشتي':'Ali Dashti', 'محمد الرشيدي':'Mohammad Al-Rashidi',  'يوسف صباح':'Yousef Sabah', 'حمد الحربي':'Hamad Al-Harbi', 'فيصل الشطي':'Faisal Al-Shatti', 'وليد سعد':'Waleed Saad', 'محمد عليان':'Mohammad Alyan',
