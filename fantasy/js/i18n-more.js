...
const NAMES_EN = {
  ...
  'ايوالا':'Iwuala', 'وليد ولد الشيخ':'Walid Ould-Chikh', 'بدر الدين سوياد':'Badreddine Souyad', 'ناصر الرواحي':'Nasser Al-Rawahi', 'لويسنهو':'Luisinho', 'مسفر العدواني':'Mesfer Al-Adwani', 'زيد قنبر':'Zaid Qanbar',
  // كاظمة
  ...
  'محمد نعيم':'Mohammad Naeem', 'احمد النصر':'Ahmad Al-Nasr', 'كارلوس':'Carlos', 'جاسم كرم':'Jassim Karam', 'فهد الشلال':'Fahad Al-Shallal', 'فاضل الصراف':'Fadhel Al-Sarraf', 'احمد الشمري':'Ahmad Al-Shammari', 'عبدالرحمن سالم':'Abdulrahman Salem', 'عبدالعزيز ناجي':'Abdulaziz Naji',
  ...
  // التضامن
  'داود الخالدي':'Dawoud Al-Khalidi', 'نايف العازمي':'Naif Al-Azmi', 'عمر العازمي':'Omar Al-Azmi', 'ابراهيم الظفيري':'Ibrahim Al-Dhafiri', 'احمد الرشيدي':'Ahmad Al-Rashidi', 'محمد عجاج':'Mohammad Ajaj', 'مزيد نواف':'Mazyad Nawaf', 'حسين العريان':'Hussain Al-Arayan', 'عايد ماجد':'Ayed Majed', 'فواز الداوود':'Fawaz Al-Dawood', 'سعود العنبري':'Saud Al-Anbari', 'حسين اشكناني':'Hussain Ashkanani', 'طلال المطرود':'Talal Al-Matroud', 'صالح الرويضان':'Saleh Al-Ruwaidan', 'عبدالرحمن الاصيمع':'Abdulrahman Al-Usaimi', 'عبدالعزيز المسافر':'Abdulaziz Al-Musafer', 'فهد العميري':'Fahad Al-Umairi', 'علي دشتي':'Ali Dashti', 'محمد الرشيدي':'Mohammad Al-Rashidi',  'يوسف صباح':'Yousef Sabah', 'حمد الحربي':'Hamad Al-Harbi', 'فيصل الشطي':'Faisal Al-Shatti', 'وليد سعد':'Waleed Saad', 'محمد عليان':'Mohammad Alyan',
