...
const VIEWS = {
  ...
  auth(){
    ...
    return `<div class="auth-hero">
      ...
      <div class="card">
        ...
        ${CLOUD.isIOSApp() ? `<p class="tiny" style="text-align:center;margin:2px 0 0">حسابك بـGoogle؟ Google لا يسمح بالدخول داخل التطبيقات — اضغط «نسيت كلمة المرور» وعيّن كلمة مرور لنفس حسابك.</p>` : `
  ...
  dashboard(){
    ...
    const links=[
      ...
      ['about','dev','الدعم والاقتراحات','راسل الدعم الفني أو اقترح أو بلّغ عن خطأ'],
    ];
