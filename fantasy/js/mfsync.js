...
const MF_SQUAD_ADD = {
  'العربي': [ {n:'وليد ولد الشيخ', p:'CAM', s:0, price:8.5}, {n:'علي عبدالرسول', p:'LB', s:16}, {n:'علي الدوخي', p:'ST', s:9}, {n:'عمر العازمي', p:'CM', s:27}, {n:'حسين كنكوني', p:'GK', s:1}, {n:'حسين العريان', p:'ST', s:99}, {n:'عايد ماجد', p:'CB', s:36}, {n:'يوسف صباح', p:'CAM', s:70}, {n:'حمد الحربي', p:'CDM', s:12}, {n:'فواز الداوود', p:'CAM', s:88}, {n:'سعود العنبري', p:'ST', s:40}, {n:'حسين اشكناني', p:'CM', s:8}, {n:'طلال المطرود', p:'RB', s:0}, {n:'صالح الرويضان', p:'LM', s:90}, {n:'بدر الدين سوياد', p:'CB', s:0} ],
  ...
  'القادسية': [ {n:'ناصر الرواحي', p:'RM', s:0} ],   /* منصور 2026-09-20: جناح أيمن عُماني — بلا سعر مقترح، يحدّده المدير */
...
const MF_SQUAD_NUM = [
  ...
  {c:'العربي', n:'حسين اشكناني', s:8, p:'CM'},
...
const MFSYNC = {
  ...
  ALIAS: {
    ...
    /* الموقع «أبوبكر دومبيا» وكشفنا «أبوبكر دوما» — كان يُطابَق بليفنشتاين (فرق
       حرفين) وهو هامش رفيع: أي لاعب تضامن باسم قريب قد يسرق المطابقة. المدخل
       هنا يجعلها حرفية. يُحذف متى وُحِّد الاسم في كشف الفانتسي، وإلى ذلك الحين
       لا يضر: إن لم يوجد «أبوبكر دوما» يسقط السطر وتكمل المطابقة العادية. */
    'TDM|أبوبكر دومبيا':'أبوبكر دوما',
  },
  ...
  async importRound(gw, opts){
    ...
    for(const m of ms){
      ...
      // خانة «+» (x) في تبديلات الموقع — الوقت بدل الضائع — تُسقَط عمداً، وحقلا
      // add1/add2 في المباراة لا يُستوردان: الفانتسي يحسب على مباراة 90 دقيقة
