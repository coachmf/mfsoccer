...
const MF_SQUAD_ADD = {
  'العربي': [ {n:'وليد ولد الشيخ', p:'CAM', s:0, price:8.5}, {n:'علي عبدالرسول', p:'LB', s:16}, {n:'علي الدوخي', p:'ST', s:9}, {n:'عمر العازمي', p:'CM', s:27}, {n:'حسين كنكوني', p:'GK', s:1}, {n:'حسين العريان', p:'ST', s:99}, {n:'عايد ماجد', p:'CB', s:90}, {n:'يوسف صباح', p:'CAM', s:70}, {n:'حمد حربي', p:'CDM', s:12} ],
