...
const COACHES = {
  ...
  photo(c, face){ if(!c || !c.slug) return ''; const v = face===true ? '_f' : face==='s' ? '_s' : face==='b' ? '_body' : ''; return `/assets/coaches/${c.slug}${v}.webp?v=30`; },  /* 'b' = صورة واقفة كاملة (Gemini 2026-09-20) */
